...
const std::string PUZZLE_SEARCH_PROP_PATH = "daoju1.PNG";   //拼图的搜索镜道具
const std::string PUZZLE_ADD_TIME_PROP_PATH = "daoju3.PNG";   //拼图加时道具
const std::string PUZZLE_BIG_EYES_PROP_PATH = "daoju2.PNG";   //拼图大眼珠子道具
...
const int BUBBLE_DOWN_FROM_AIR_IMPULSE_MAX_Y = -1000; //泡泡下落时候添加的最大冲量
const int BUBBLE_DOWN_FROM_AIR_IMPULSE_MIN_Y = -5000; //泡泡下落时候添加的最小冲量
...
//小球刚体
const int BUBBLE_BODY_MASS = 150;    //小球质量
...
const std::string GAME_FATIGUE_PATH = "tili.PNG"; //疲劳
