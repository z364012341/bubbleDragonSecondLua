...
const float PHYSICS_BARREL_BOTTOM_BODY_DENSITY = 0.0f; //Í°±ß¸ÕÌåÃÜ¶È
const float PHYSICS_BARREL_BOTTOM_BODY_RESTITUTION = 0.0f;   //Í°±ß¸ÕÌå·´µ¯Á¦
const float PHYSICS_BARREL_BOTTOM_BODY_FRICTION = 50000.0f; //Í°±ß¸ÕÌåÄ¦²ÁÁ¦
