...
//int lua_SmartScaleController_SmartScaleController_operator=(lua_State* tolua_S)
//{
//    int argc = 0;
//    bubble_second::SmartScaleController* cobj = nullptr;
//    bool ok  = true;
...
//    if (!cobj) 
//    {
//        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_SmartScaleController_SmartScaleController_operator='", nullptr);
//        return 0;
//    }
//#endif
//
...
//    if (argc == 1) 
//    {
//        bubble_second::SmartScaleController arg0;
//
//        ok &= luaval_to_object<bubble_second::SmartScaleController>(tolua_S, 2, "bs.SmartScaleController",&arg0, "bs.SmartScaleController:operator=");
//        if(!ok)
//        {
//            tolua_error(tolua_S,"invalid arguments in function 'lua_SmartScaleController_SmartScaleController_operator='", nullptr);
//            return 0;
//        }
//        bubble_second::SmartScaleController& ret = cobj->operator=(arg0);
...
//        return 1;
//    }
//    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "bs.SmartScaleController:operator=",argc, 1);
//    return 0;
//
//#if COCOS2D_DEBUG >= 1
//    tolua_lerror:
//    tolua_error(tolua_S,"#ferror in function 'lua_SmartScaleController_SmartScaleController_operator='.",&tolua_err);
//#endif
//
//    return 0;
//}
...
int lua_register_SmartScaleController_SmartScaleController(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SmartScaleController");
        ...
        //tolua_function(tolua_S,"operator=",lua_SmartScaleController_SmartScaleController_operator=);
