...
int lua_SpriteTextureController_SpriteTextureController_createWhitePurpleFnt(lua_State* tolua_S)
{
    int argc = 0;
    bubble_second::SpriteTextureController* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_SpriteTextureController_SpriteTextureController_createWhitePurpleFnt'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "bs.SpriteTextureController:createWhitePurpleFnt");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_SpriteTextureController_SpriteTextureController_createWhitePurpleFnt'", nullptr);
            return 0;
        }
        cocos2d::ui::TextBMFont* ret = cobj->createWhitePurpleFnt(arg0);
        object_to_luaval<cocos2d::ui::TextBMFont>(tolua_S, "ccui.TextBMFont",(cocos2d::ui::TextBMFont*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "bs.SpriteTextureController:createWhitePurpleFnt",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_SpriteTextureController_SpriteTextureController_createWhitePurpleFnt'.",&tolua_err);
#endif
...
int lua_SpriteTextureController_SpriteTextureController_createPropSpriteWithKey(lua_State* tolua_S)
{
    int argc = 0;
    bubble_second::SpriteTextureController* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_SpriteTextureController_SpriteTextureController_createPropSpriteWithKey'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "bs.SpriteTextureController:createPropSpriteWithKey");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_SpriteTextureController_SpriteTextureController_createPropSpriteWithKey'", nullptr);
            return 0;
        }
        cocos2d::Sprite* ret = cobj->createPropSpriteWithKey(arg0);
        object_to_luaval<cocos2d::Sprite>(tolua_S, "cc.Sprite",(cocos2d::Sprite*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "bs.SpriteTextureController:createPropSpriteWithKey",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_SpriteTextureController_SpriteTextureController_createPropSpriteWithKey'.",&tolua_err);
#endif
...
int lua_register_SpriteTextureController_SpriteTextureController(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SpriteTextureController");
        ...
        tolua_function(tolua_S,"createWhitePurpleFnt",lua_SpriteTextureController_SpriteTextureController_createWhitePurpleFnt);
        ...
        tolua_function(tolua_S,"createPropSpriteWithKey",lua_SpriteTextureController_SpriteTextureController_createPropSpriteWithKey);
