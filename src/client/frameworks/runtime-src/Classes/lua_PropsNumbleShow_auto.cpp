...
int lua_PropsNumbleShow_PropsNumbleShow_isNoneProp(lua_State* tolua_S)
{
    int argc = 0;
    bubble_second::PropsNumbleShow* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_PropsNumbleShow_PropsNumbleShow_isNoneProp'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PropsNumbleShow_PropsNumbleShow_isNoneProp'", nullptr);
            return 0;
        }
        bool ret = cobj->isNoneProp();
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "bs.PropsNumbleShow:isNoneProp",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PropsNumbleShow_PropsNumbleShow_isNoneProp'.",&tolua_err);
#endif
...
int lua_register_PropsNumbleShow_PropsNumbleShow(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PropsNumbleShow");
        ...
        tolua_function(tolua_S,"isNoneProp",lua_PropsNumbleShow_PropsNumbleShow_isNoneProp);
