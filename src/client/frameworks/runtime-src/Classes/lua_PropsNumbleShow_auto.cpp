...
int lua_PropsNumbleShow_PropsNumbleShow_addPropNumble(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_PropsNumbleShow_PropsNumbleShow_addPropNumble'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PropsNumbleShow_PropsNumbleShow_addPropNumble'", nullptr);
            return 0;
        }
        cobj->addPropNumble();
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "bs.PropsNumbleShow:addPropNumble");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_PropsNumbleShow_PropsNumbleShow_addPropNumble'", nullptr);
            return 0;
        }
        cobj->addPropNumble(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "bs.PropsNumbleShow:addPropNumble",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_PropsNumbleShow_PropsNumbleShow_addPropNumble'.",&tolua_err);
#endif
...
int lua_register_PropsNumbleShow_PropsNumbleShow(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PropsNumbleShow");
        tolua_function(tolua_S,"addPropNumble",lua_PropsNumbleShow_PropsNumbleShow_addPropNumble);
